...
**The Game Area**
  ...
  - The two displays, one for the player and one for the computer, are shown here responsively to the option selected by the player and the one selected by the computer.
...
**The Moves Area**
  - This section shows the number of moves in the game. The default is 10 moves. One move is subtracted after each click. When there are no more moves left, the result of the game is displayed on the result page.
...
**The Score Area**
  - This section shows the options chosen by the player and the computer, and their relative scores are also calculated and displayed.
...
<img width="549" alt="Screenshot 2024-05-04 at 11 03 47" src="https://github.com/aliceC119/rock-paper-scissors-lizard-spock-game/assets/162838985/3a7c6e2e-8b1e-494e-9cd7-a8dbcc003525">
  ...
  **Validator Testing**
  ...
  + JavaScript
    - No errors were found when passing through the offical https://jshint.com/
      ...
      - Two unused variables are found: playGame & clearDisplay. However these two variables are being used in HTML.
        ...
        <img width="577" alt="Screenshot 2024-05-04 at 17 43 47" src="https://github.com/aliceC119/rock-paper-scissors-lizard-spock-game/assets/162838985/fc9f5631-bd57-49a2-98dc-549243b9355f">
  ...
  # Credits
  + The code to create the favicon is taken by the Love Running Project.
  + The codes of linking the selected choice of move images to the display images are inspired by https://www.youtube.com/watch?v=fIBOydve2f8
  + The codes for setting up the game logic are inspired by https://www.youtube.com/watch?v=3uKdQx-SZ5A&t=441s
  ...
  + The codes to set the computer's random selection were inspired by and taken from the Love Maths Project.
